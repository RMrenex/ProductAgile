...
public class Main {
    ...
    public static double applyTVA(double price, String countryCode) {
    ...
    public static int setDiscount(int choice) {
    ...
    public static double getDiscountRate(double price) {
    ...
    public static double getDiscountRateForTest(double price, int quantity) {
        double discountRate = 0;
        if (quantity > 1000 && quantity < 5000) {
            discountRate = getDiscount(price, DISCOUNTS[0]);
        } else if (quantity > 5000 && quantity < 7000) {
